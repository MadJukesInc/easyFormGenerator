...
!function (e, t, n) {
    ...
    angular.module('mgcrea.ngStrap.tooltip', ['mgcrea.ngStrap.core', 'mgcrea.ngStrap.helpers.dimensions']).provider('$tooltip', function () {
            ...
            function p(i, r) {
                ...
                function C(e, t) {
                    ...
                    isNaN(i) && (i = 0), isNaN(r) && (r = 0), e.top = e.top + i, e.left = e.left + r, c.setOffset(n, angular.extend({
                        using: function (e) {
                            R.css({top: Math.round(e.top) + 'px', left: Math.round(e.left) + 'px', right: ''})
                        }
                    }, e), 0);
                ...
                O.then(function (e) {
                    ...
                    if (V.bsEnabled && !F.$isShown) {
                        ...
                        V.container ? (e = Y, t = Y[0].lastChild ? angular.element(Y[0].lastChild) : null) : (e = null, t = i), R && A(), q = F.$scope.$new(), R = F.$element = U.link(q, function (e, t) {
                            ...
                            R && R.css({visibility: 'visible'}), V.keyboard && ('focus' !== V.trigger && F.focus(), y())
                        }), V.autoClose && D()
                    }
                }, F.leave = function () {
                ...
                F.hide = function (e) {
                    ...
                    if (R) {
                        ...
                        if (F.$viewport = V.viewport && m(V.viewport.selector || V.viewport), a) {
                            ...
                            /top/.test(s) && o.bottom + r > l.bottom ? t = s.replace('top', 'bottom') : /bottom/.test(s) && o.top - r < l.top && (t = s.replace('bottom', 'top')), /left/.test(s) && o.left - i < l.left ? t = t.replace('left', 'right') : /right/.test(s) && o.right + i > l.width && (t = t.replace('right', 'left')), R.removeClass(s).addClass(t)
                        }
                        var u = T(t, o, i, r);
                        C(u, t)
                    }
        ...
        this.$get = ['$window', '$document', '$rootScope', '$tooltip', '$timeout', function (t, n, a, o, i) {
            function r(a, r, s) {
                ...
                return u.hide = function () {
                    !c.multiple && angular.isUndefined(r.$modelValue) && (d.$activeIndex = -1), u.$element.off(l ? 'touchstart' : 'mousedown', u.$onMouseDown), c.keyboard && a.off('keydown', u.$onKeyDown), p(!0)
                }, u
            }
    ...
    }]), angular.module('mgcrea.ngStrap.core', []).service('$bsCompiler', a), a.$inject = ['$q', '$http', '$injector', '$compile', '$controller', '$templateCache'], angular.module('mgcrea.ngStrap.navbar', []).provider('$navbar', function () {
        ...
        this.$get = ['$window', '$rootScope', '$bsCompiler', '$animate', '$timeout', '$sce', 'dimensions', function (n, a, o, i, r, s, l) {
            function u(t) {
                ...
                function r() {
                    T.$emit(S.prefixEvent + '.hide', k), g.removeClass(S.prefixClass + '-open'), S.animation && g.removeClass(S.prefixClass + '-with-' + S.animation)
                }

                function l() {
                    S.backdrop && (E.on('click', y), A.on('click', y), A.on('wheel', b))
                }

                function u() {
                    S.backdrop && (E.off('click', y), A.off('click', y), A.off('wheel', b))
                }
                ...
                function D() {
                    k.$isShown && null !== E && (u(), w()), M && (M.$destroy(), M = null), E && (E.remove(), E = k.$element = null)
                }

                var k = {}, S = k.$options = angular.extend({}, e, t), x = k.$promise = o.compile(S), T = k.$scope = S.scope && S.scope.$new() || a.$new();
                S.element || S.container || (S.container = 'body'), k.$id = S.id || S.element && S.element.attr('id') || '', f(['title', 'content'], function (e) {
                ...
                return A.css({
                    ...
                    D(), A && (A.remove(), A = null), T.$destroy()
                }, k.show = function () {
                    if (!k.$isShown) {
                        var e, t;
                        if (angular.isElement(S.container) ? (e = S.container, t = S.container[0].lastChild ? angular.element(S.container[0].lastChild) : null) : S.container ? (e = d(S.container), t = e[0] && e[0].lastChild ? angular.element(e[0].lastChild) : null) : (e = null, t = S.element), E && D(), M = k.$scope.$new(), E = k.$element = C.link(M, function (e, t) {
                            }), S.backdrop && (E.css({'z-index': $ + 20 * m}), A.css({'z-index': h + 20 * m}), m++), !T.$emit(S.prefixEvent + '.show.before', k).defaultPrevented) {
                            E.css({display: 'block'}).addClass(S.placement), S.animation && (S.backdrop && A.addClass(S.backdropAnimation), E.addClass(S.animation)), S.backdrop && i.enter(A, g, null), angular.version.minor <= 2 ? i.enter(E, e, t, n) : i.enter(E, e, t).then(n), k.$isShown = T.$isShown = !0, c(T);
                            var a = E[0];
                            p(function () {
                                a.focus()
                            }), g.addClass(S.prefixClass + '-open'), S.animation && g.addClass(S.prefixClass + '-with-' + S.animation), l(), v()
                        }
                    }
                }, k.hide = function () {
                    k.$isShown && (S.backdrop && m--, T.$emit(S.prefixEvent + '.hide.before', k).defaultPrevented || (angular.version.minor <= 2 ? i.leave(E, r) : i.leave(E).then(r), S.backdrop && i.leave(A), k.$isShown = T.$isShown = !1, c(T), u(), w()))
                }, k.toggle = function () {
            ...
            var f = angular.forEach, p = (String.prototype.trim, n.requestAnimationFrame || n.setTimeout), g = angular.element(n.document.body), m = 0, $ = 1050, h = 1040;
            return u
        }]
        ...
        return {
            restrict: 'EAC', scope: !0, compile: function (e, t) {
                if (!t.bsDropdown) {
                    ...
                    o.classList.contains('dropdown-menu') && (t.template = o.outerHTML, t.templateUrl = n, o.parentNode.removeChild(o))
                }
                return function (e, n, o) {
                    ...
                    angular.forEach(['html', 'container'], function (e) {
                        ...
                        e.content = t
                    }, !0), o.bsShow && e.$watch(o.bsShow, function (e, t) {
                ...
                var r = i.$scope, s = i.$options, l = s.lang, u = function (e, t) {
                    ...
                    format: s.dayFormat, split: 7, steps: {month: 1}, update: function (e, t) {
                        !this.built || t || e.getFullYear() !== m.year || e.getMonth() !== m.month ? (angular.extend(m, {
                            year: i.$date.getFullYear(), month: i.$date.getMonth(), date: i.$date.getDate()
