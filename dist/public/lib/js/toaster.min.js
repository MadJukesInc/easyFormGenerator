...
!function () {
    ...
    angular.module("toaster", []).constant("toasterConfig", {
        ...
        return {
            ...
            replace: !0,
            link: function (o, s, i) {
                o.$watch("directiveName", function (n) {
                    if (angular.isUndefined(n) || n.length <= 0)throw new Error("A valid directive name must be provided via the toast body argument when using bodyOutputType: directive");
                    var a = e.has(i.$normalize(n) + "Directive");
                    if (!a)throw new Error(n + " could not be found.");
        ...
        return {
            ...
            link: function (e, r, c) {
                ...
                function u(o, i) {
                    if (o.type = v["icon-classes"][o.type], o.type || (o.type = v["icon-class"]), v["prevent-duplicates"] === !0)if (p(i)) {
                ...
                function m(t) {
                    for (var o = e.toasters.length - 1; o >= 0; o--)p(t) ? d(o) : e.toasters[o].uid == t && d(o)
                }
                ...
                v = angular.extend({}, i, e.$eval(c.toasterOptions)), e.config = {
                    ...
                    (p(e.config.toasterId) && p(o) || !p(e.config.toasterId) && !p(o) && e.config.toasterId == o) && u(n.toast, s)
