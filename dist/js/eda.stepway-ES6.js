...
$__System.register('f', [], function (_export) {
    ...
    $__System.registerDynamic("12", [], true, function ($__require, exports, module) {
        ...
        var global = this,
            __define = global.define;
        global.define = undefined;
        module.exports = "<div class=\"modal-header\">\n    <h3 class=\"modal-title greyText\">{{'SELECT_A_CTRL' | translate}}</h3>\n</div>\n<div class=\"modal-body\">\n    <hr/>\n    <div class=\"row\">\n        <div class=\"col-xs-12 col-sm-12 col-md-12 col-lg-12\">\n            <h5 class=\"greyText\"><i class=\"fa fa-filter\"></i>&nbsp; {{'SELECT_CTRL_IN_LIST' | translate}} :</h5>\n        </div>\n        <div class=\"col-xs-12 col-sm-12 col-md-12 col-lg-12\">\n            <ol class=\"nya-bs-select col-xs-12 col-sm-12 col-md-12 col-lg-12\"\n                ng-model=\"editControlModCtrl.modelNyaSelect\" data-live-search=\"false\">\n                <li nya-bs-option=\"option in editControlModCtrl.nyaSelectFiltered.controls group by option.group\">\n                    <span class=\"dropdown-header greyText\">{{$group}}</span> <!-- group header cannot be searched -->\n                    <a ng-click=\"editControlModCtrl.selectThisControl(option.id)\">\n                        <span>{{ option.name }}</span>\n                        <span class=\"glyphicon glyphicon-ok check-mark\"></span>\n                    </a>\n                </li>\n            </ol>\n        </div>\n    </div>\n    <hr/>\n    <div ng-switch on=\"editControlModCtrl.nyaSelect.selectedControl\">\n        <!--no control selected-->\n        <div ng-switch-when=\"none\">\n            <div class=\"row\">\n                <div class=\"col-sm-12\">\n                    <h5 class=\"text-center texteRouge\"><i class=\"fa fa-arrow-up\"></i>&nbsp; {{'SELECT_A_CTRL' |\n                        translate}}</h5>\n                </div>\n            </div>\n        </div>\n        <!--empty (or blank) control -->\n        <div ng-switch-when=\"empty\">\n            <div class=\"panel panel-default\">\n                <div class=\"panel-body\">\n                    <div class=\"row\">\n                        <div class=\"col-md-12\">\n                            <h5 class=\"greyText\"><i class=\"fa fa-eye\"></i>&nbsp; {{'PREVIEW_TAB' | translate}} :</h5>\n                        </div>\n                    </div>\n                    <hr/>\n                    <div class=\"row\">\n                        <div class=\"col-sm-12\">\n                            <h5 class=\"text-center greyText\">{{'COL_WILL_BE_BLANK' | translate}}</h5>\n                        </div>\n                    </div>\n                </div>\n            </div>\n        </div>\n        <!--header-->\n        <div ng-switch-when=\"Header\">\n            <div class=\"panel panel-default\">\n                <div class=\"panel-body\">\n                    <div class=\"row\">\n                        <div class=\"col-md-12\">\n                            <h5 class=\"greyText\"><i class=\"fa fa-eye\"></i>&nbsp; {{'PREVIEW_TAB' | translate}} :</h5>\n                        </div>\n                    </div>\n                    <hr/>\n                    <div class=\"row\">\n                        <div class=\"col-md-12\">\n                            <div class=\"form-group\">\n                                <div class=\"\">\n                                    <h2 class=\"text-center\">\n                                        {{editControlModCtrl.nyaSelect.temporyConfig.formlyDesciption}}</h2>\n                                    <hr/>\n                                </div>\n                            </div>\n                        </div>\n                    </div>\n                </div>\n            </div>\n            <div class=\"panel panel-default\">\n                <div class=\"panel-body\">\n                    <div class=\"row\">\n                        <div class=\"col-md-12\">\n                            <h5 class=\"greyText\"><i class=\"fa fa-pencil-square-o\"></i>&nbsp; {{'EDIT_PROPERTIES' |\n                                translate}} :</h5>\n                        </div>\n                    </div>\n                    <hr/>\n                    <div class=\"marginTopFivepixels\"></div>\n                    <div class=\"row\">\n                        <div class=\"form-group\">\n                            <label for=\"inputTextDescriptionUpdate\"\n                                   class=\"col-lg-3 control-label greyText editPropertiesLabel\">{{'HEADER_TEXT' |\n                                translate}} :</label>\n                            <div class=\"col-lg-9\">\n                                <input type=\"text\" class=\"form-control\"\n                                       ng-model=\"editControlModCtrl.nyaSelect.temporyConfig.formlyDesciption\"\n                                       id=\"inputHeaderTextUpdate\" placeholder=\"{{'ADD_EDIT_HEADER_HERE' | translate}}\">\n                            </div>\n                        </div>\n                    </div>\n                </div>\n            </div>\n        </div>\n        <!--Subtitle-->\n        <div ng-switch-when=\"Subtitle\">\n            <div class=\"panel panel-default\">\n                <div class=\"panel-body\">\n                    <div class=\"row\">\n                        <div class=\"col-md-12\">\n                            <h5 class=\"greyText\"><i class=\"fa fa-eye\"></i>&nbsp; {{'PREVIEW_TAB' | translate}} :</h5>\n                        </div>\n                    </div>\n                    <hr/>\n                    <div class=\"row\">\n                        <div class=\"col-md-12\">\n                            <div class=\"form-group\">\n                                <div class=\"\">\n                                    <h4 class=\"text-center\">\n                                        {{editControlModCtrl.nyaSelect.temporyConfig.formlyPlaceholder}}</h4>\n                                    <hr/>\n                                </div>\n                            </div>\n                        </div>\n                    </div>\n                </div>\n            </div>\n            <div class=\"panel panel-default\">\n                <div class=\"panel-body\">\n                    <div class=\"row\">\n                        <div class=\"col-md-12\">\n                            <h5 class=\"greyText\"><i class=\"fa fa-pencil-square-o\"></i>&nbsp; {{'EDIT_PROPERTIES' |\n                                translate}} :</h5>\n                        </div>\n                    </div>\n                    <hr/>\n                    <div class=\"marginTopFivepixels\"></div>\n                    <div class=\"row\">\n                        <div class=\"form-group\">\n                            <label for=\"inputSubTitleTextUpdate\"\n                                   class=\"col-lg-3 control-label greyText editPropertiesLabel\">{{'SUBTITLE_TEXT' |\n                                translate}} :</label>\n                            <div class=\"col-lg-9\">\n                                <input type=\"text\" class=\"form-control\"\n                                       ng-model=\"editControlModCtrl.nyaSelect.temporyConfig.formlyPlaceholder\"\n                                       id=\"inputSubTitleTextUpdate\"\n                                       placeholder=\"{{'ADD_EDIT_SUBTIL_HERE' | translate}}\">\n                            </div>\n                        </div>\n                    </div>\n                </div>\n            </div>\n        </div>\n        <!-- TextInput -->\n        <div ng-switch-when=\"TextInput\">\n            <div class=\"panel panel-default\">\n                <div class=\"panel-body\">\n                    <div class=\"row\">\n                        <div class=\"col-md-12\">\n                            <h5 class=\"greyText\"><i class=\"fa fa-eye\"></i>&nbsp; {{'PREVIEW_TAB' | translate}} :</h5>\n                        </div>\n                    </div>\n                    <hr/>\n                    <div class=\"row\">\n                        <div class=\"col-md-12\">\n                            <div class=\"form-group\">\n                                <label for=\"inputText\" class=\"control-label textControlLabel\">{{editControlModCtrl.nyaSelect.temporyConfig.formlyLabel}}<span\n                                        ng-if=\"editControlModCtrl.nyaSelect.temporyConfig.formlyRequired\"\n                                        class=\"textControlLabel\">*</span></label>\n                                <div class=\"\">\n                                    <input type=\"text\" class=\"form-control\" id=\"inputText\"\n                                           placeholder=\"{{editControlModCtrl.nyaSelect.temporyConfig.formlyPlaceholder}}\">\n                                    <p class=\"help-block\">\n                                        {{editControlModCtrl.nyaSelect.temporyConfig.formlyDesciption}}</p>\n                                </div>\n                            </div>\n                        </div>\n                    </div>\n                </div>\n            </div>\n            <div class=\"panel panel-default\">\n                <div class=\"panel-body\">\n                    <div class=\"row\">\n                        <div class=\"col-md-12\">\n                            <h5 class=\"greyText\"><i class=\"fa fa-pencil-square-o\"></i>&nbsp; {{'EDIT_PROPERTIES' |\n                                translate}} :</h5>\n                        </div>\n                    </div>\n                    <hr/>\n                    <div class=\"row\">\n                        <div class=\"form-group\">\n                            <label for=\"inputTextLabelUpdate\"\n                                   class=\"col-lg-3 control-label greyText editPropertiesLabel\">{{'LABEL_TEXT' |\n                                translate}} :</label>\n                            <div class=\"col-lg-9\">\n                                <input type=\"text\" class=\"form-control\"\n                                       ng-model=\"editControlModCtrl.nyaSelect.temporyConfig.formlyLabel\"\n                                       id=\"inputTextLabelUpdate\" placeholder=\"{{'ADD_EDIT_LABEL_HERE' | translate}}\">\n                            </div>\n                        </div>\n                    </div>\n                    <div class=\"marginTopFivepixels\"></div>\n                    <div class=\"row\">\n                        <div class=\"form-group\">\n                            <label for=\"inputTextplaceholderUpdate\"\n                                   class=\"col-lg-3 control-label greyText editPropertiesLabel\">{{'PLACEHOLDER' |\n                                translate}} :</label>\n                            <div class=\"col-lg-9\">\n                                <input type=\"text\" class=\"form-control\"\n                                       ng-model=\"editControlModCtrl.nyaSelect.temporyConfig.formlyPlaceholder\"\n                                       id=\"inputTextplaceholderUpdate\"\n                                       placeholder=\"{{'ADD_EDIT_PLACEHOLD' | translate}}\">\n                            </div>\n                        </div>\n                    </div>\n                    <div class=\"marginTopFivepixels\"></div>\n                    <div class=\"row\">\n                        <div class=\"form-group\">\n                            <label for=\"inputTextRequiredUpdate\"\n                                   class=\"col-lg-3 control-label greyText editPropertiesLabel\">{{'REQUIRED' |\n                                translate}} :</label>\n                            <div class=\"col-lg-9\">\n                                <div class=\"checkboxCssCorrection\">&nbsp;</div>\n                                <input type=\"checkbox\"\n                                       ng-model=\"editControlModCtrl.nyaSelect.temporyConfig.formlyRequired\"\n                                       id=\"inputTextRequiredUpdate\">\n                            </div>\n                        </div>\n                    </div>\n                    <div class=\"marginTopFivepixels\"></div>\n                    <div class=\"row\">\n                        <div class=\"form-group\">\n                            <label for=\"inputTextDescriptionUpdate\"\n                                   class=\"col-lg-3 control-label greyText editPropertiesLabel\">{{'DESCRIPTION' |\n                                translate}} :</label>\n                            <div class=\"col-lg-9\">\n                                <input type=\"text\" class=\"form-control\"\n                                       ng-model=\"editControlModCtrl.nyaSelect.temporyConfig.formlyDesciption\"\n                                       id=\"inputTextDescriptionUpdate\"\n                                       placeholder=\"{{'ADDEDIT_DESCRIPTION' | translate}}\">\n                            </div>\n                        </div>\n                    </div>\n                </div>\n            </div>\n        </div>\n        <!-- Number -->\n        <div ng-switch-when=\"Number\">\n            <div class=\"panel panel-default\">\n                <div class=\"panel-body\">\n                    <div class=\"row\">\n                        <div class=\"col-md-12\">\n                            <h5 class=\"greyText\"><i class=\"fa fa-eye\"></i>&nbsp; {{'PREVIEW_TAB' | translate}} :</h5>\n                        </div>\n                    </div>\n                    <hr/>\n                    <div class=\"row\">\n                        <div class=\"col-md-12\">\n                            <div class=\"form-group\">\n                                <label for=\"inputText\" class=\"control-label textControlLabel\">{{editControlModCtrl.nyaSelect.temporyConfig.formlyLabel}}<span\n                                        ng-if=\"editControlModCtrl.nyaSelect.temporyConfig.formlyRequired\"\n                                        class=\"textControlLabel\">*</span></label>\n                                <div class=\"\">\n                                    <input type=\"number\" class=\"form-control\" id=\"inputNumber\"\n                                           placeholder=\"{{editControlModCtrl.nyaSelect.temporyConfig.formlyPlaceholder}}\">\n                                    <p class=\"help-block\">\n                                        {{editControlModCtrl.nyaSelect.temporyConfig.formlyDesciption}}</p>\n                                </div>\n                            </div>\n                        </div>\n                    </div>\n                </div>\n            </div>\n            <div class=\"panel panel-default\">\n                <div class=\"panel-body\">\n                    <div class=\"row\">\n                        <div class=\"col-md-12\">\n                            <h5 class=\"greyText\"><i class=\"fa fa-pencil-square-o\"></i>&nbsp; {{'EDIT_PROPERTIES' |\n                                translate}} :</h5>\n                        </div>\n                    </div>\n                    <hr/>\n                    <div class=\"row\">\n                        <div class=\"form-group\">\n                            <label for=\"inputTextLabelUpdate\"\n                                   class=\"col-lg-3 control-label greyText editPropertiesLabel\">{{'LABEL_TEXT' |\n                                translate}} :</label>\n                            <div class=\"col-lg-9\">\n                                <input type=\"text\" class=\"form-control\"\n                                       ng-model=\"editControlModCtrl.nyaSelect.temporyConfig.formlyLabel\"\n                                       id=\"inputNumberabelUpdate\" placeholder=\"{{'ADD_EDIT_LABEL_HERE' | translate}}\">\n                            </div>\n                        </div>\n                    </div>\n                    <div class=\"marginTopFivepixels\"></div>\n                    <div class=\"row\">\n                        <div class=\"form-group\">\n                            <label for=\"inputTextplaceholderUpdate\"\n                                   class=\"col-lg-3 control-label greyText editPropertiesLabel\">{{'PLACEHOLDER' |\n                                translate}} :</label>\n                            <div class=\"col-lg-9\">\n                                <input type=\"text\" class=\"form-control\"\n                                       ng-model=\"editControlModCtrl.nyaSelect.temporyConfig.formlyPlaceholder\"\n                                       id=\"inputNumberplaceholderUpdate\"\n                                       placeholder=\"{{'ADD_EDIT_PLACEHOLD' | translate}}\">\n                            </div>\n                        </div>\n                    </div>\n                    <div class=\"marginTopFivepixels\"></div>\n                    <div class=\"row\">\n                        <div class=\"form-group\">\n                            <label for=\"inputTextRequiredUpdate\"\n                                   class=\"col-lg-3 control-label greyText editPropertiesLabel\">{{'REQUIRED' |\n                                translate}} :</label>\n                            <div class=\"col-lg-9\">\n                                <div class=\"checkboxCssCorrection\">&nbsp;</div>\n                                <input type=\"checkbox\"\n                                       ng-model=\"editControlModCtrl.nyaSelect.temporyConfig.formlyRequired\"\n                                       id=\"inputNumberRequiredUpdate\">\n                            </div>\n                        </div>\n                    </div>\n                    <div class=\"marginTopFivepixels\"></div>\n                    <div class=\"row\">\n                        <div class=\"form-group\">\n                            <label for=\"inputTextDescriptionUpdate\"\n                                   class=\"col-lg-3 control-label greyText editPropertiesLabel\">{{'DESCRIPTION' |\n                                translate}} :</label>\n                            <div class=\"col-lg-9\">\n                                <input type=\"text\" class=\"form-control\"\n                                       ng-model=\"editControlModCtrl.nyaSelect.temporyConfig.formlyDesciption\"\n                                       id=\"inputNumberDescriptionUpdate\"\n                                       placeholder=\"{{'ADDEDIT_DESCRIPTION' | translate}}\">\n                            </div>\n                        </div>\n                    </div>\n                </div>\n            </div>\n        </div>\n        <!-- password -->\n        <div ng-switch-when=\"Password\">\n            <div class=\"panel panel-default\">\n                <div class=\"panel-body\">\n                    <div class=\"row\">\n                        <div class=\"col-md-12\">\n                            <h5 class=\"greyText\"><i class=\"fa fa-eye\"></i>&nbsp; {{'PREVIEW_TAB' | translate}} :</h5>\n                        </div>\n                    </div>\n                    <hr/>\n                    <div class=\"row\">\n                        <div class=\"col-md-12\">\n                            <div class=\"form-group\">\n                                <label for=\"inputPassword\" class=\"control-label textControlLabel\">{{editControlModCtrl.nyaSelect.temporyConfig.formlyLabel}}<span\n                                        ng-if=\"editControlModCtrl.nyaSelect.temporyConfig.formlyRequired\"\n                                        class=\"textControlLabel\">*</span></label>\n                                <div class=\"\">\n                                    <input type=\"password\" class=\"form-control\" id=\"inputPassword\"\n                                           placeholder=\"{{editControlModCtrl.nyaSelect.temporyConfig.formlyPlaceholder}}\">\n                                    <p class=\"help-block\">\n                                        {{editControlModCtrl.nyaSelect.temporyConfig.formlyDesciption}}</p>\n                                </div>\n                            </div>\n                        </div>\n                    </div>\n                </div>\n            </div>\n\n            <div class=\"panel panel-default\">\n                <div class=\"panel-body\">\n\n                    <div class=\"row\">\n                        <div class=\"col-md-12\">\n                            <h5 class=\"greyText\"><i class=\"fa fa-pencil-square-o\"></i>&nbsp; {{'EDIT_PROPERTIES' |\n                                translate}} :</h5>\n                        </div>\n                    </div>\n                    <hr/>\n\n                    <div class=\"row\">\n                        <div class=\"form-group\">\n                            <label for=\"inputTextLabelUpdate\"\n                                   class=\"col-lg-3 control-label greyText editPropertiesLabel\">{{'LABEL_TEXT' |\n                                translate}} :</label>\n                            <div class=\"col-lg-9\">\n                                <input type=\"text\" class=\"form-control\"\n                                       ng-model=\"editControlModCtrl.nyaSelect.temporyConfig.formlyLabel\"\n                                       id=\"inputTextLabelUpdate\" placeholder=\"{{'ADD_EDIT_LABEL_HERE' | translate}}\">\n                            </div>\n                        </div>\n                    </div>\n\n\n                    <div class=\"marginTopFivepixels\"></div>\n\n                    <div class=\"row\">\n                        <div class=\"form-group\">\n                            <label for=\"inputTextplaceholderUpdate\"\n                                   class=\"col-lg-3 control-label greyText editPropertiesLabel\">{{'PLACEHOLDER' |\n                                translate}} :</label>\n                            <div class=\"col-lg-9\">\n                                <input type=\"text\" class=\"form-control\"\n                                       ng-model=\"editControlModCtrl.nyaSelect.temporyConfig.formlyPlaceholder\"\n                                       id=\"inputTextplaceholderUpdate\"\n                                       placeholder=\"{{'ADD_EDIT_PLACEHOLD' | translate}}\">\n                            </div>\n                        </div>\n                    </div>\n\n\n                    <div class=\"marginTopFivepixels\"></div>\n\n                    <div class=\"row\">\n                        <div class=\"form-group\">\n                            <label for=\"inputTextRequiredUpdate\"\n                                   class=\"col-lg-3 control-label greyText editPropertiesLabel\">{{'REQUIRED' |\n                                translate}} :</label>\n                            <div class=\"col-lg-9\">\n                                <div class=\"checkboxCssCorrection\">&nbsp;</div>\n                                <input type=\"checkbox\"\n                                       ng-model=\"editControlModCtrl.nyaSelect.temporyConfig.formlyRequired\"\n                                       id=\"inputTextRequiredUpdate\">\n                            </div>\n                        </div>\n                    </div>\n\n                    <div class=\"marginTopFivepixels\"></div>\n\n                    <div class=\"row\">\n                        <div class=\"form-group\">\n                            <label for=\"inputTextDescriptionUpdate\"\n                                   class=\"col-lg-3 control-label greyText editPropertiesLabel\">{{'DESCRIPTION' |\n                                translate}} :</label>\n                            <div class=\"col-lg-9\">\n                                <input type=\"text\" class=\"form-control\"\n                                       ng-model=\"editControlModCtrl.nyaSelect.temporyConfig.formlyDesciption\"\n                                       id=\"inputTextDescriptionUpdate\"\n                                       placeholder=\"{{'ADDEDIT_DESCRIPTION' | translate}}\">\n                            </div>\n                        </div>\n                    </div>\n\n                </div>\n            </div>\n        </div>\n\n        <div ng-switch-when=\"Email\">\n            <!-- password -->\n            <div class=\"panel panel-default\">\n                <div class=\"panel-body\">\n\n                    <div class=\"row\">\n                        <div class=\"col-md-12\">\n                            <h5 class=\"greyText\"><i class=\"fa fa-eye\"></i>&nbsp; {{'PREVIEW_TAB' | translate}} :</h5>\n                        </div>\n                    </div>\n                    <hr/>\n\n                    <div class=\"row\">\n\n                        <div class=\"col-md-12\">\n\n                            <div class=\"form-group\">\n\n                                <label for=\"inputEmail\" class=\"control-label textControlLabel\">{{editControlModCtrl.nyaSelect.temporyConfig.formlyLabel}}<span\n                                        ng-if=\"editControlModCtrl.nyaSelect.temporyConfig.formlyRequired\"\n                                        class=\"textControlLabel\">*</span></label>\n\n\n                                <div class=\"\">\n                                    <input type=\"text\" class=\"form-control\" id=\"inputEmail\"\n                                           placeholder=\"{{editControlModCtrl.nyaSelect.temporyConfig.formlyPlaceholder}}\">\n                                    <p class=\"help-block\">\n                                        {{editControlModCtrl.nyaSelect.temporyConfig.formlyDesciption}}</p>\n                                </div>\n\n\n                            </div>\n\n                        </div>\n\n                    </div>\n                </div>\n            </div>\n\n            <div class=\"panel panel-default\">\n                <div class=\"panel-body\">\n\n                    <div class=\"row\">\n                        <div class=\"col-md-12\">\n                            <h5 class=\"greyText\"><i class=\"fa fa-pencil-square-o\"></i>&nbsp; {{'EDIT_PROPERTIES' |\n                                translate}} :</h5>\n                        </div>\n                    </div>\n                    <hr/>\n\n                    <div class=\"row\">\n                        <div class=\"form-group\">\n                            <label for=\"inputTextLabelUpdate\"\n                                   class=\"col-lg-3 control-label greyText editPropertiesLabel\">{{'LABEL_TEXT' |\n                                translate}} :</label>\n                            <div class=\"col-lg-9\">\n                                <input type=\"text\" class=\"form-control\"\n                                       ng-model=\"editControlModCtrl.nyaSelect.temporyConfig.formlyLabel\"\n                                       id=\"inputTextLabelUpdate\" placeholder=\"{{'ADD_EDIT_LABEL_HERE' | translate}}\">\n                            </div>\n                        </div>\n                    </div>\n\n\n                    <div class=\"marginTopFivepixels\"></div>\n\n                    <div class=\"row\">\n                        <div class=\"form-group\">\n                            <label for=\"inputTextplaceholderUpdate\"\n                                   class=\"col-lg-3 control-label greyText editPropertiesLabel\">{{'PLACEHOLDER' |\n                                translate}} :</label>\n                            <div class=\"col-lg-9\">\n                                <input type=\"text\" class=\"form-control\"\n                                       ng-model=\"editControlModCtrl.nyaSelect.temporyConfig.formlyPlaceholder\"\n                                       id=\"inputTextplaceholderUpdate\"\n                                       placeholder=\"{{'ADD_EDIT_PLACEHOLD' | translate}}\">\n                            </div>\n                        </div>\n                    </div>\n\n\n                    <div class=\"marginTopFivepixels\"></div>\n\n                    <div class=\"row\">\n                        <div class=\"form-group\">\n                            <label for=\"inputTextRequiredUpdate\"\n                                   class=\"col-lg-3 control-label greyText editPropertiesLabel\">{{'REQUIRED' |\n                                translate}} :</label>\n                            <div class=\"col-lg-9\">\n                                <div class=\"checkboxCssCorrection\">&nbsp;</div>\n                                <input type=\"checkbox\"\n                                       ng-model=\"editControlModCtrl.nyaSelect.temporyConfig.formlyRequired\"\n                                       id=\"inputTextRequiredUpdate\">\n                            </div>\n                        </div>\n                    </div>\n\n                    <div class=\"marginTopFivepixels\"></div>\n\n                    <div class=\"row\">\n                        <div class=\"form-group\">\n                            <label for=\"inputTextDescriptionUpdate\"\n                                   class=\"col-lg-3 control-label greyText editPropertiesLabel\">{{'DESCRIPTION' |\n                                translate}} :</label>\n                            <div class=\"col-lg-9\">\n                                <input type=\"text\" class=\"form-control\"\n                                       ng-model=\"editControlModCtrl.nyaSelect.temporyConfig.formlyDesciption\"\n                                       id=\"inputTextDescriptionUpdate\"\n                                       placeholder=\"{{'ADDEDIT_DESCRIPTION' | translate}}\">\n                            </div>\n                        </div>\n                    </div>\n\n                </div>\n            </div>\n        </div>\n\n        <div ng-switch-when=\"Date\">\n            <!-- datetimepicker (input type date not ok in all browsers) -->\n            <div class=\"panel panel-default\">\n                <div class=\"panel-body\">\n\n                    <div class=\"row\">\n                        <div class=\"col-md-12\">\n                            <h5 class=\"greyText\"><i class=\"fa fa-eye\"></i>&nbsp; {{'PREVIEW_TAB' | translate}} :</h5>\n                        </div>\n                    </div>\n                    <hr/>\n\n                    <div class=\"row\">\n\n                        <div class=\"col-md-12\">\n\n                            <div class=\"form-group\">\n\n                                <label for=\"inputDate\" class=\"control-label textControlLabel\">{{editControlModCtrl.nyaSelect.temporyConfig.formlyLabel}}<span\n                                        ng-if=\"editControlModCtrl.nyaSelect.temporyConfig.formlyRequired\"\n                                        class=\"textControlLabel\">*</span></label>\n\n                                <div class=\"\">\n\n                                    <div class=\"input-group\">\n                                        <span class=\"input-group-addon\"><i\n                                                class=\"glyphicon glyphicon-calendar\"></i></span>\n\n                                        <input type=\"text\" class=\"form-control\"\n                                               uib-datepicker-popup=\"{{editControlModCtrl.nyaSelect.temporyConfig.datepickerPopup}}\"\n                                               ng-model=\"editControlModCtrl.demodt.dt\"\n                                               is-open=\"editControlModCtrl.demodt.opened\"\n                                               min-date=\"editControlModCtrl.demodt.minDate\" max-date=\"'2099-12-31'\"\n                                               uib-datepicker-options=\"editControlModCtrl.dateOptions\"\n                                               date-disabled=\"editControlModCtrl.disabled(date, mode)\"\n                                               close-text=\"Close\" ng-click=\"editControlModCtrl.open($event)\"/>\n                                    </div>\n\n                                    </p>\n                                    <p class=\"help-block\">\n                                        {{editControlModCtrl.nyaSelect.temporyConfig.formlyDesciption}}</p>\n                                </div>\n                            </div>\n                        </div>\n                    </div>\n                </div>\n            </div>\n\n            <div class=\"panel panel-default\">\n                <div class=\"panel-body\">\n\n                    <div class=\"row\">\n                        <div class=\"col-md-12\">\n                            <h5 class=\"greyText\"><i class=\"fa fa-pencil-square-o\"></i>&nbsp; {{'EDIT_PROPERTIES' |\n                                translate}} :</h5>\n                        </div>\n                    </div>\n                    <hr/>\n\n                    <div class=\"row\">\n                        <div class=\"form-group\">\n                            <label class=\"col-lg-3 control-label greyText editPropertiesLabel\">{{'DATE_FORMAT' |\n                                translate}} :</label>\n                            <div class=\"col-lg-9\">\n\n                                <ol class=\"nya-bs-select col-sm-12 col-xs-12 col-md-12 col-lg12\"\n                                    ng-model=\"editControlModCtrl.nyaSelect.temporyConfig.datepickerPopup\"\n                                    id=\"dateformatSelect\">\n                                    <li class=\"nya-bs-option\"\n                                        nya-bs-option=\"dateformat in editControlModCtrl.demodt.formats\"\n                                        value=\"dateformat\">\n                                        <a>{{dateformat}}</a>\n                                    </li>\n                                </ol>\n\n                            </div>\n                        </div>\n                    </div>\n\n                    <div class=\"marginTopFivepixels\"></div>\n\n                    <div class=\"row\">\n                        <div class=\"form-group\">\n                            <label for=\"inputTextLabelUpdate\"\n                                   class=\"col-lg-3 control-label greyText editPropertiesLabel\">{{'LABEL_TEXT' |\n                                translate}} :</label>\n                            <div class=\"col-lg-9\">\n                                <input type=\"text\" class=\"form-control\"\n                                       ng-model=\"editControlModCtrl.nyaSelect.temporyConfig.formlyLabel\"\n                                       id=\"inputTextLabelUpdate\" placeholder=\"{{'ADD_EDIT_LABEL_HERE' | translate}}\">\n                            </div>\n                        </div>\n                    </div>\n\n                    <div class=\"marginTopFivepixels\"></div>\n\n                    <div class=\"row\">\n                        <div class=\"form-group\">\n                            <label for=\"inputTextRequiredUpdate\"\n                                   class=\"col-lg-3 control-label greyText editPropertiesLabel\">{{'REQUIRED' |\n                                translate}} :</label>\n                            <div class=\"col-lg-9\">\n                                <div class=\"checkboxCssCorrection\">&nbsp;</div>\n                                <input type=\"checkbox\"\n                                       ng-model=\"editControlModCtrl.nyaSelect.temporyConfig.formlyRequired\"\n                                       id=\"inputTextRequiredUpdate\">\n                            </div>\n                        </div>\n                    </div>\n\n                    <div class=\"marginTopFivepixels\"></div>\n\n                    <div class=\"row\">\n                        <div class=\"form-group\">\n                            <label for=\"inputTextDescriptionUpdate\"\n                                   class=\"col-lg-3 control-label greyText editPropertiesLabel\">{{'DESCRIPTION' |\n                                translate}} :</label>\n                            <div class=\"col-lg-9\">\n                                <input type=\"text\" class=\"form-control\"\n                                       ng-model=\"editControlModCtrl.nyaSelect.temporyConfig.formlyDesciption\"\n                                       id=\"inputTextDescriptionUpdate\"\n                                       placeholder=\"{{'ADDEDIT_DESCRIPTION' | translate}}\">\n                            </div>\n                        </div>\n                    </div>\n\n                </div>\n            </div>\n        </div>\n\n        <div ng-switch-when=\"Texarea\">\n            <!-- textarea -->\n            <div class=\"panel panel-default\">\n                <div class=\"panel-body\">\n\n\n                    <div class=\"row\">\n                        <div class=\"col-md-12\">\n                            <h5 class=\"greyText\"><i class=\"fa fa-eye\"></i>&nbsp; {{'PREVIEW_TAB' | translate}} :</h5>\n                        </div>\n                    </div>\n                    <hr/>\n\n                    <div class=\"row\">\n\n                        <div class=\"col-md-12\">\n\n                            <div class=\"form-group\">\n\n                                <label for=\"textArea\" class=\"control-label textControlLabel\">{{editControlModCtrl.nyaSelect.temporyConfig.formlyLabel}}<span\n                                        ng-if=\"editControlModCtrl.nyaSelect.temporyConfig.formlyRequired\"\n                                        class=\"textControlLabel\">*</span></label>\n\n                                <div class=\"\">\n                                    <textarea class=\"form-control\" ng-model=\"model[options.key]\" rows=\"3\"\n                                              id=\"textArea\"></textarea>\n                                    <p class=\"help-block\">\n                                        {{editControlModCtrl.nyaSelect.temporyConfig.formlyDesciption}}</p>\n                                </div>\n\n                            </div>\n\n                        </div>\n\n                    </div>\n                </div>\n            </div>\n\n            <div class=\"panel panel-default\">\n                <div class=\"panel-body\">\n\n                    <div class=\"row\">\n                        <div class=\"col-md-12\">\n                            <h5 class=\"greyText\"><i class=\"fa fa-pencil-square-o\"></i>&nbsp; {{'EDIT_PROPERTIES' |\n                                translate}} :</h5>\n                        </div>\n                    </div>\n                    <hr/>\n\n                    <div class=\"row\">\n                        <div class=\"form-group\">\n                            <label for=\"inputTextLabelUpdate\"\n                                   class=\"col-lg-3 control-label greyText editPropertiesLabel\">{{'LABEL_TEXT' |\n                                translate}} :</label>\n                            <div class=\"col-lg-9\">\n                                <input type=\"text\" class=\"form-control\"\n                                       ng-model=\"editControlModCtrl.nyaSelect.temporyConfig.formlyLabel\"\n                                       id=\"inputTextLabelUpdate\" placeholder=\"{{'ADD_EDIT_LABEL_HERE' | translate}}\">\n                            </div>\n                        </div>\n                    </div>\n\n\n                    <div class=\"marginTopFivepixels\"></div>\n\n                    <div class=\"row\">\n                        <div class=\"form-group\">\n                            <label for=\"inputTextRequiredUpdate\"\n                                   class=\"col-lg-3 control-label greyText editPropertiesLabel\">{{'REQUIRED' |\n                                translate}} :</label>\n                            <div class=\"col-lg-9\">\n                                <div class=\"checkboxCssCorrection\">&nbsp;</div>\n                                <input type=\"checkbox\"\n                                       ng-model=\"editControlModCtrl.nyaSelect.temporyConfig.formlyRequired\"\n                                       id=\"inputTextRequiredUpdate\">\n                            </div>\n                        </div>\n                    </div>\n\n                    <div class=\"marginTopFivepixels\"></div>\n\n                    <div class=\"row\">\n                        <div class=\"form-group\">\n                            <label for=\"inputTextDescriptionUpdate\"\n                                   class=\"col-lg-3 control-label greyText editPropertiesLabel\">{{'DESCRIPTION' |\n                                translate}} :</label>\n                            <div class=\"col-lg-9\">\n                                <input type=\"text\" class=\"form-control\"\n                                       ng-model=\"editControlModCtrl.nyaSelect.temporyConfig.formlyDesciption\"\n                                       id=\"inputTextDescriptionUpdate\"\n                                       placeholder=\"{{'ADDEDIT_DESCRIPTION' | translate}}\">\n                            </div>\n                        </div>\n                    </div>\n\n                </div>\n            </div>\n        </div>\n\n        <div ng-switch-when=\"RichTextEditor\">\n            <!-- TextInput -->\n            <div class=\"panel panel-default\">\n                <div class=\"panel-body\">\n\n                    <div class=\"row\">\n                        <div class=\"col-md-12\">\n                            <h5 class=\"greyText\"><i class=\"fa fa-eye\"></i>&nbsp; {{'PREVIEW_TAB' | translate}} :</h5>\n                        </div>\n                    </div>\n                    <hr/>\n\n                    <div class=\"row\">\n\n                        <div class=\"col-md-12\">\n\n                            <div class=\"form-group\">\n\n                                <label for=\"RichTextEditor\" class=\"control-label textControlLabel\">{{editControlModCtrl.nyaSelect.temporyConfig.formlyLabel}}<span\n                                        ng-if=\"editControlModCtrl.nyaSelect.temporyConfig.formlyRequired\"\n                                        class=\"textControlLabel\">*</span></label>\n\n                                <div class=\"\">\n\n                                    <text-angular ng-model=\"editControlModCtrl.model[options.key]\"></text-angular>\n                                    <p class=\"help-block\">\n                                        {{editControlModCtrl.nyaSelect.temporyConfig.formlyDesciption}}</p>\n                                </div>\n\n                            </div>\n                        </div>\n                    </div>\n                </div>\n            </div>\n\n            <div class=\"panel panel-default\">\n                <div class=\"panel-body\">\n\n                    <div class=\"row\">\n                        <div class=\"col-md-12\">\n                            <h5 class=\"greyText\"><i class=\"fa fa-pencil-square-o\"></i>&nbsp; {{'EDIT_PROPERTIES' |\n                                translate}} :</h5>\n                        </div>\n                    </div>\n                    <hr/>\n\n                    <!-- required can't be applied to rich text editor (textAngular) right now -->\n                    <!--<div class=\"row\">\n                                    <div class=\"form-group\">\n                                        <label for=\"inputTextRequiredUpdate\" class=\"col-lg-3 control-label greyText editPropertiesLabel\">Required :</label>\n                                        <div class=\"col-lg-9\">\n                                            <div class=\"checkboxCssCorrection\">&nbsp;</div>\n                                            <input type=\"checkbox\" ng-model=\"nyaSelect.temporyConfig.formlyRequired\" id=\"inputTextRequiredUpdate\">\n                                        </div>\n                                    </div>\n                    </div>\n\n\n                    <div class=\"marginTopFivepixels\"></div>-->\n\n\n                    <div class=\"row\">\n                        <div class=\"form-group\">\n                            <label for=\"inputTextDescriptionUpdate\"\n                                   class=\"col-lg-3 control-label greyText editPropertiesLabel\">{{'DESCRIPTION' |\n                                translate}} :</label>\n                            <div class=\"col-lg-9\">\n                                <input type=\"text\" class=\"form-control\"\n                                       ng-model=\"editControlModCtrl.nyaSelect.temporyConfig.formlyDesciption\"\n                                       id=\"inputTextDescriptionUpdate\"\n                                       placeholder=\"{{'ADDEDIT_DESCRIPTION' | translate}}\">\n                            </div>\n                        </div>\n                    </div>\n\n\n                </div>\n            </div>\n        </div>\n\n        <div ng-switch-when=\"Radio\">\n            <!-- radios -->\n            <div class=\"panel panel-default\">\n                <div class=\"panel-body\">\n\n                    <div class=\"row\">\n                        <div class=\"col-md-12\">\n                            <h5 class=\"greyText\"><i class=\"fa fa-eye\"></i>&nbsp; {{'PREVIEW_TAB' | translate}} :</h5>\n                        </div>\n                    </div>\n                    <hr/>\n\n                    <div class=\"row\">\n\n                        <div class=\"col-md-12\">\n\n                            <div class=\"form-group\">\n\n                                <label for=\"basicSelect\" class=\"control-label textControlLabel\">{{editControlModCtrl.nyaSelect.temporyConfig.formlyLabel}}<span\n                                        ng-if=\"editControlModCtrl.nyaSelect.temporyConfig.formlyRequired\"\n                                        class=\"textControlLabel\">*</span></label>\n\n                                <div class=\"\">\n\n                                    <div class=\"radio\"\n                                         ng-repeat=\"radioRow in editControlModCtrl.radioRowCollection.rows\">\n                                        <label>\n                                            <input type=\"radio\" name=\"optionsRadios\" id=\"{{'optionsRadio-' + $index}}\"\n                                                   value=\"$index\" checked=\"\">\n                                            {{radioRow.option}}\n                                        </label>\n                                    </div>\n                                    <p class=\"help-block\">\n                                        {{editControlModCtrl.nyaSelect.temporyConfig.formlyDesciption}}</p>\n\n                                </div>\n                            </div>\n\n                        </div>\n\n                    </div>\n                </div>\n            </div>\n\n            <div class=\"panel panel-default\">\n                <div class=\"panel-body\">\n\n                    <div class=\"row\">\n                        <div class=\"col-md-12\">\n                            <h5 class=\"greyText\"><i class=\"fa fa-pencil-square-o\"></i>&nbsp; {{'EDIT_PROPERTIES' |\n                                translate}} :</h5>\n                        </div>\n                    </div>\n                    <hr/>\n\n                    <div class=\"row\">\n                        <div class=\"col-lg-3 col-md-3\">\n                            <label for=\"radioRowCollection\" class=\" control-label greyText editPropertiesLabel\">{{'ADD_NEW_RADIO'\n                                | translate}} :</label>\n                        </div>\n                    </div>\n\n                    <div class=\"row\">\n                        <div>\n\n                            <div class=\"form-group\">\n\n                                <div class=\"col-sm-9 col-xs-9 col-md-9 col-lg-9\">\n                                    <input type=\"text\" class=\"form-control\" id=\"inputAddNewRadioOption\"\n                                           placeholder=\"{{'ADD_RADIO_PLACEHOLD' | translate}}\"\n                                           ng-model=\"editControlModCtrl.newOptionRadio.saisie\">\n                                </div>\n\n                                <div class=\"col-sm-3 col-xs-3 col-md-3 col-lg-3\">\n                                    <button class=\"btn btn-primary\" ng-click=\"editControlModCtrl.addNewOptionRadio()\">\n                                        {{'ADD' | translate}}\n                                    </button>\n                                </div>\n\n                            </div>\n                        </div>\n                    </div>\n\n\n                    <div class=\"row\">\n                        <div class=\"col-lg-3 col-md-3\">\n                            <label for=\"radioRowCollection\" class=\" control-label greyText editPropertiesLabel\">{{'EDIT_REMOVE_RADIO'\n                                | translate}} :</label>\n                        </div>\n                    </div>\n                    <div class=\"row\">\n                        <div class=\"form-group\">\n\n                            <div class-\n                            \"col-lg-12 col-md-12 col-sm-12 col-xs-12\">\n\n                            <div class=\"container\">\n\n                                <div ng-show=\"editControlModCtrl.radioRowCollection.rows.length === 0\">\n                                    <h5 class=\"text-center greyText\"><em>- {{'NO_RADIO_ADD_NEW' | translate}} -</em>\n                                    </h5>\n                                </div>\n\n\n                                <table ng-if=\"editControlModCtrl.radioRowCollection.rows.length > 0\"\n                                       class=\"table table-striped\">\n                                    <thead>\n                                    <tr>\n                                        <th st-ratio=\"20\">{{'ORDER' | translate}}</th>\n                                        <th st-ratio=\"55\">{{'OPTION' | translate}}</th>\n                                        <th st-ratio=\"25\"></th>\n                                    </tr>\n                                    <tr>\n                                        <th st-ratio=\"20\"></th>\n                                        <th st-ratio=\"55\">\n                                            <input ng-model=\"editControlModCtrl.radioFilter\"\n                                                   placeholder=\"{{'SEARCH_4_OPTION' | translate}}\"\n                                                   class=\"input-sm form-control\" type=\"search\"/>\n                                        </th>\n                                        <th st-ratio=\"25\"></th>\n                                    </tr>\n                                    </thead>\n                                    <tbody>\n                                    <tr ng-repeat=\"radioRow in editControlModCtrl.radioRowCollection.rows | filter:radioFilter as radioRow\">\n                                        <td st-ratio=\"20\">{{$index}}</td>\n                                        <td st-ratio=\"55\">{{radioRow.option}}</td>\n                                        <td st-ratio=\"25\">\n\n                                            <div class=\"pull-right\">\n                                                <button class=\"btn btn-primary\"\n                                                        ng-click=\"editControlModCtrl.upThisRadioRow($index)\"><i\n                                                        class=\"fa fa-arrow-up\"></i></button>\n\n                                                <button class=\"btn btn-primary\"\n                                                        ng-click=\"editControlModCtrl.downThisRadioRow($index)\"><i\n                                                        class=\"fa fa-arrow-down\"></i></button>\n\n                                                <button class=\"btn btn-danger\"\n                                                        ng-click=\"editControlModCtrl.removeRadioRow($index)\"><i\n                                                        class=\"fa fa-trash-o\"></i></button>\n                                            </div>\n\n                                        </td>\n                                    </tr>\n                                    </tbody>\n\n                                </table>\n                            </div>\n                        </div>\n                    </div>\n                </div>\n                <hr/>\n\n\n                <div class=\"marginTopFivepixels\"></div>\n\n\n                <div class=\"row\">\n                    <div class=\"form-group\">\n                        <label for=\"inputTextLabelUpdate\" class=\"col-lg-3 control-label greyText editPropertiesLabel\">{{'LABEL_TEXT'\n                            | translate}} :</label>\n                        <div class=\"col-lg-9\">\n                            <input type=\"text\" class=\"form-control\"\n                                   ng-model=\"editControlModCtrl.nyaSelect.temporyConfig.formlyLabel\"\n                                   id=\"inputTextLabelUpdate\" placeholder=\"{{'ADD_EDIT_LABEL_HERE' | translate}}\">\n                        </div>\n                    </div>\n                </div>\n\n                <div class=\"marginTopFivepixels\"></div>\n\n                <div class=\"row\">\n                    <div class=\"form-group\">\n                        <label for=\"inputTextRequiredUpdate\"\n                               class=\"col-lg-3 control-label greyText editPropertiesLabel\">{{'REQUIRED' | translate}}\n                            :</label>\n                        <div class=\"col-lg-9\">\n                            <div class=\"checkboxCssCorrection\">&nbsp;</div>\n                            <input type=\"checkbox\" ng-model=\"editControlModCtrl.nyaSelect.temporyConfig.formlyRequired\"\n                                   id=\"inputTextRequiredUpdate\">\n                        </div>\n                    </div>\n                </div>\n\n                <div class=\"marginTopFivepixels\"></div>\n\n                <div class=\"row\">\n                    <div class=\"form-group\">\n                        <label for=\"inputTextDescriptionUpdate\"\n                               class=\"col-lg-3 control-label greyText editPropertiesLabel\">{{'DESCRIPTION' | translate}}\n                            :</label>\n                        <div class=\"col-lg-9\">\n                            <input type=\"text\" class=\"form-control\"\n                                   ng-model=\"editControlModCtrl.nyaSelect.temporyConfig.formlyDesciption\"\n                                   id=\"inputTextDescriptionUpdate\" placeholder=\"{{'ADDEDIT_DESCRIPTION' | translate}}\">\n                        </div>\n                    </div>\n                </div>\n\n            </div>\n        </div>\n    </div>\n\n    <div ng-switch-when=\"Checkbox\">\n        <!-- checkbox -->\n        <div class=\"panel panel-default\">\n            <div class=\"panel-body\">\n\n\n                <div class=\"row\">\n                    <div class=\"col-md-12\">\n                        <h5 class=\"greyText\"><i class=\"fa fa-eye\"></i>&nbsp; {{'PREVIEW_TAB' | translate}} :</h5>\n                    </div>\n                </div>\n                <hr/>\n\n                <div class=\"row\">\n\n                    <div class=\"col-md-12\">\n\n                        <div class=\"form-group\">\n\n                            <div class=\"col-md-12\">\n                                <div class=\"checkbox\">\n                                    <label>\n                                        <input type=\"checkbox\" id=\"checkBox\"> <span class=\"blackText\">{{editControlModCtrl.nyaSelect.temporyConfig.formlyLabel}}</span><span\n                                            ng-if=\"editControlModCtrl.nyaSelect.temporyConfig.formlyRequired\"\n                                            class=\"textControlLabel\">*</span>\n                                    </label>\n\n                                </div>\n                                <p class=\"help-block\">\n                                    {{editControlModCtrl.nyaSelect.temporyConfig.formlyDesciption}}</p>\n                            </div>\n\n                        </div>\n\n                    </div>\n\n                </div>\n            </div>\n        </div>\n\n        <div class=\"panel panel-default\">\n            <div class=\"panel-body\">\n\n                <div class=\"row\">\n                    <div class=\"col-md-12\">\n                        <h5 class=\"greyText\"><i class=\"fa fa-pencil-square-o\"></i>&nbsp; {{'EDIT_PROPERTIES' |\n                            translate}} :</h5>\n                    </div>\n                </div>\n                <hr/>\n\n                <div class=\"row\">\n                    <div class=\"form-group\">\n                        <label for=\"inputTextLabelUpdate\" class=\"col-lg-3 control-label greyText editPropertiesLabel\">{{'LABEL_TEXT'\n                            | translate}} :</label>\n                        <div class=\"col-lg-9\">\n                            <input type=\"text\" class=\"form-control\"\n                                   ng-model=\"editControlModCtrl.nyaSelect.temporyConfig.formlyLabel\"\n                                   id=\"inputTextLabelUpdate\" placeholder=\"{{'ADD_EDIT_LABEL_HERE' | translate}}\">\n                        </div>\n                    </div>\n                </div>\n\n                <div class=\"marginTopFivepixels\"></div>\n\n                <div class=\"row\">\n                    <div class=\"form-group\">\n                        <label for=\"inputTextRequiredUpdate\"\n                               class=\"col-lg-3 control-label greyText editPropertiesLabel\">{{'REQUIRED' | translate}}\n                            :</label>\n                        <div class=\"col-lg-9\">\n                            <div class=\"checkboxCssCorrection\">&nbsp;</div>\n                            <input type=\"checkbox\" ng-model=\"editControlModCtrl.nyaSelect.temporyConfig.formlyRequired\"\n                                   id=\"inputTextRequiredUpdate\">\n                        </div>\n                    </div>\n                </div>\n\n                <div class=\"marginTopFivepixels\"></div>\n\n                <div class=\"row\">\n                    <div class=\"form-group\">\n                        <label for=\"inputTextDescriptionUpdate\"\n                               class=\"col-lg-3 control-label greyText editPropertiesLabel\">{{'DESCRIPTION' | translate}}\n                            :</label>\n                        <div class=\"col-lg-9\">\n                            <input type=\"text\" class=\"form-control\"\n                                   ng-model=\"editControlModCtrl.nyaSelect.temporyConfig.formlyDesciption\"\n                                   id=\"inputTextDescriptionUpdate\" placeholder=\"{{'ADDEDIT_DESCRIPTION' | translate}}\">\n                        </div>\n                    </div>\n                </div>\n\n            </div>\n        </div>\n    </div>\n\n    <div ng-switch-when=\"BasicSelect\">\n\n        <!--  basic selects -->\n        <div class=\"panel panel-default\">\n            <div class=\"panel-body\">\n\n                <div class=\"row\">\n                    <div class=\"col-md-12\">\n                        <h5 class=\"greyText\"><i class=\"fa fa-eye\"></i>&nbsp; {{'PREVIEW_TAB' | translate}} :</h5>\n                    </div>\n                </div>\n                <hr/>\n\n\n                <div class=\"row\">\n                    <div class=\"col-md-12\">\n                        <div class=\"form-group\">\n\n                            <label for=\"basicSelect\" class=\"control-label textControlLabel\">{{editControlModCtrl.nyaSelect.temporyConfig.formlyLabel}}<span\n                                    ng-if=\"editControlModCtrl.nyaSelect.temporyConfig.formlyRequired\"\n                                    class=\"textControlLabel\">*</span></label>\n\n                            <div class=\"\">\n\n                                <ol class=\"nya-bs-select col-sm-12 col-xs-12 col-md-12 col-lg12\"\n                                    ng-model=\"editControlModCtrl.modelbasicSelect\" id=\"basicSelect\"\n                                    disabled=\"editControlModCtrl.basicSelectRowCollection.rows.length === 0\">\n                                    <li class=\"nya-bs-option\"\n                                        nya-bs-option=\"basicSelectRow in editControlModCtrl.basicSelectRowCollection.rows\"\n                                        value=\"$index\">\n                                        <a>{{basicSelectRow.option}}</a>\n                                    </li>\n                                </ol>\n\n                                <p class=\"help-block\">\n                                    {{editControlModCtrl.nyaSelect.temporyConfig.formlyDesciption}}</p>\n\n                            </div>\n\n                        </div>\n                    </div>\n                </div>\n            </div>\n        </div>\n\n        <div class=\"panel panel-default\">\n            <div class=\"panel-body\">\n\n                <div class=\"row\">\n                    <div class=\"col-md-12\">\n                        <h5 class=\"greyText\"><i class=\"fa fa-pencil-square-o\"></i>&nbsp; {{'EDIT_PROPERTIES' |\n                            translate}} :</h5>\n                    </div>\n                </div>\n                <hr/>\n\n\n                <div class=\"row\">\n                    <div class=\"col-lg-3 col-md-3\">\n                        <label for=\"basicSelectRowCollection\" class=\" control-label greyText editPropertiesLabel\">{{'ADD_NEW_OPTIONS'\n                            | translate}} :</label>\n                    </div>\n                </div>\n\n                <div class=\"row\">\n                    <div>\n\n                        <div class=\"form-group\">\n\n                            <div class=\"col-sm-9 col-xs-9 col-md-9 col-lg-9\">\n                                <input type=\"text\" class=\"form-control\" id=\"inputAddNewBasicOption\"\n                                       placeholder=\"{{'ADD_A_NEW_OPTION' | translate}}\"\n                                       ng-model=\"editControlModCtrl.newOptionBasicSelect.saisie\">\n                            </div>\n\n                            <div class=\"col-sm-3 col-xs-3 col-md-3 col-lg-3\">\n                                <button class=\"btn btn-primary\" ng-click=\"editControlModCtrl.addNewOptionBasicSelect()\">\n                                    {{'ADD' | translate}}\n                                </button>\n                            </div>\n\n                        </div>\n                    </div>\n                </div>\n\n                <div class=\"row\">\n                    <div class=\"col-lg-3 col-md-3\">\n                        <label class=\" control-label greyText editPropertiesLabel\">{{'EDIT_REMOVE_OPTIONS' | translate}}\n                            :</label>\n                    </div>\n                </div>\n                <div class=\"row\">\n                    <div class=\"form-group\">\n\n                        <div class=\"col-lg-12 col-md-12 col-sm-12 col-xs-12\">\n                        <div class=\"container\">\n\n                            <div ng-if=\"editControlModCtrl.basicSelectRowCollection.rows.length === 0\">\n                                <h5 class=\"text-center greyText\"><em>- {{'NO_OPTION_ADD_NEW' | translate}} -</em></h5>\n                            </div>\n\n                            <table ng-if=\"editControlModCtrl.basicSelectRowCollection.rows.length > 0\"\n                                   class=\"table table-striped\">\n                                <thead>\n                                <tr>\n                                    <th st-ratio=\"20\">{{'ORDER' | translate}}</th>\n                                    <th st-ratio=\"55\">{{'OPTION' | translate}}</th>\n                                    <th st-ratio=\"25\"></th>\n                                </tr>\n                                <tr>\n                                    <th st-ratio=\"20\"></th>\n                                    <th st-ratio=\"55\">\n                                        <input ng-model=\"basicSelectFilter\"\n                                               placeholder=\"{{'SEARCH_4_OPTION' | translate}}\"\n                                               class=\"input-sm form-control\" type=\"search\"/>\n                                    </th>\n                                    <th st-ratio=\"25\"></th>\n                                </tr>\n                                </thead>\n                                <tbody>\n                                <tr ng-repeat=\"basicSelectRow in editControlModCtrl.basicSelectRowCollection.rows | filter:basicSelectFilter as basicSelectRow\">\n                                    <td st-ratio=\"20\">{{$index}}</td>\n                                    <td st-ratio=\"55\">{{basicSelectRow.option}}</td>\n                                    <td st-ratio=\"25\">\n\n                                        <div class=\"pull-right\">\n                                            <button class=\"btn btn-primary\"\n                                                    ng-click=\"editControlModCtrl.upThisRow($index)\"><i\n                                                    class=\"fa fa-arrow-up\"></i></button>\n\n                                            <button class=\"btn btn-primary\"\n                                                    ng-click=\"editControlModCtrl.downThisRow($index)\"><i\n                                                    class=\"fa fa-arrow-down\"></i></button>\n\n                                            <button class=\"btn btn-danger\"\n                                                    ng-click=\"editControlModCtrl.removeRow($index)\"><i\n                                                    class=\"fa fa-trash-o\"></i></button>\n                                        </div>\n\n                                    </td>\n                                </tr>\n                                </tbody>\n                            </table>\n                        </div>\n                    </div>\n                </div>\n            </div>\n            <hr/>\n\n\n            <!--<div class=\"row\">\n                            <div class=\"form-group\">\n                                <label for=\"inputTextRequiredUpdate\" class=\"col-lg-3 control-label greyText editPropertiesLabel\">Required :</label>\n                                <div class=\"col-lg-9\">\n                                    <div class=\"checkboxCssCorrection\">&nbsp;</div>\n                                    <input type=\"checkbox\" ng-model=\"nyaSelect.temporyConfig.formlyRequired\" id=\"inputTextRequiredUpdate\">\n                                </div>\n                            </div>\n            </div> -->\n\n\n            <div class=\"marginTopFivepixels\"></div>\n\n\n            <div class=\"row\">\n                <div class=\"form-group\">\n                    <label for=\"inputTextDescriptionUpdate\" class=\"col-lg-3 control-label greyText editPropertiesLabel\">{{'DESCRIPTION'\n                        | translate}} :</label>\n                    <div class=\"col-lg-9\">\n                        <input type=\"text\" class=\"form-control\"\n                               ng-model=\"editControlModCtrl.nyaSelect.temporyConfig.formlyDesciption\"\n                               id=\"inputTextDescriptionUpdate\" placeholder=\"{{'ADDEDIT_DESCRIPTION' | translate}}\">\n                    </div>\n                </div>\n            </div>\n\n        </div>\n    </div>\n</div>\n\n\n<!-- grouped selects -->\n<div ng-switch-when=\"GroupedSelect\">\n    <div class=\"panel panel-default\">\n        <div class=\"panel-body\">\n            <div class=\"row\">\n                <div class=\"col-md-12\">\n                    <h5 class=\"greyText\"><i class=\"fa fa-eye\"></i>&nbsp; {{'PREVIEW_TAB' | translate}} :</h5>\n                </div>\n            </div>\n            <hr/>\n            <div class=\"row\">\n                <div class=\"col-md-12\">\n                    <div class=\"form-group\">\n                        <label for=\"select\" class=\"control-label textControlLabel\">{{editControlModCtrl.nyaSelect.temporyConfig.formlyLabel}}<span\n                                ng-if=\"editControlModCtrl.nyaSelect.temporyConfig.formlyRequired\"\n                                class=\"textControlLabel\">*</span></label>\n                        <div class=\"\">\n                            <ol class=\"nya-bs-select col-sm-12 col-xs-12 col-md-12 col-lg12\"\n                                ng-model=\"modelGroupedSelect\" data-live-search=\"true\"\n                                disabled=\"editControlModCtrl.groupedSelectRowCollection.rows.length === 0\">\n                                <li nya-bs-option=\"groupedSelectRow in editControlModCtrl.groupedSelectRowCollection.rows group by groupedSelectRow.group\"\n                                    value=\"$index\">\n                                    <span class=\"dropdown-header\">{{groupedSelectRow.group}}</span>\n                                    <a>\n                                        <span>{{groupedSelectRow.option}}</span>\n                                        <span class=\"glyphicon glyphicon-ok check-mark\"></span>\n                                    </a>\n                                </li>\n                            </ol>\n                            <p class=\"help-block\">{{editControlModCtrl.nyaSelect.temporyConfig.formlyDesciption}}</p>\n                        </div>\n                    </div>\n                </div>\n            </div>\n        </div>\n    </div>\n    <div class=\"panel panel-default\">\n        <div class=\"panel-body\">\n            <div class=\"row\">\n                <div class=\"col-md-12\">\n                    <h5 class=\"greyText\"><i class=\"fa fa-pencil-square-o\"></i>&nbsp; {{'EDIT_PROPERTIES' | translate}} :\n                    </h5>\n                </div>\n            </div>\n            <hr/>\n            <div class=\"row\">\n                <div class=\"col-lg-3 col-md-3\">\n                    <label for=\"groupedSelectRowCollection\" class=\" control-label greyText editPropertiesLabel\">{{'ADD_NEW_OPTIONS'\n                        | translate}} :</label>\n                </div>\n            </div>\n            <div class=\"row\">\n                <div>\n                    <div class=\"form-group\">\n                        <div class=\"col-sm-9 col-xs-9 col-md-9 col-lg-9\">\n                            <input type=\"text\" class=\"form-control\" id=\"inputAddNewGroupedOption\"\n                                   placeholder=\"{{'ADD_A_NEW_OPTION' | translate}}\"\n                                   ng-model=\"editControlModCtrl.newOptionGroupedSelect.saisie\">\n                        </div>\n                        <div class=\"col-sm-3 col-xs-3 col-md-3 col-lg-3\">\n                            <button class=\"btn btn-primary\" ng-click=\"editControlModCtrl.addNewOptionGroupedSelect()\">\n                                {{'ADD' | translate}}\n                            </button>\n                        </div>\n                    </div>\n                </div>\n            </div>\n            <div class=\"row\">\n                <div class=\"col-lg-3 col-md-3\">\n                    <label for=\"groupedSelectRowCollection\" class=\" control-label greyText editPropertiesLabel\">{{'ADD_NEW_GROUPS'\n                        | translate}} :</label>\n                </div>\n            </div>\n            <div class=\"row\">\n                <div>\n                    <div class=\"form-group\">\n                        <div class=\"col-sm-9 col-xs-9 col-md-9 col-lg-9\">\n                            <input id=\"inputAddNewGroupGroupedOption\" type=\"text\" class=\"form-control\"\n                                   ng-model=\"editControlModCtrl.newGroupGroupedSelect.saisie\"\n                                   id=\"inputTextLabelUpdateGroupedSelect\"\n                                   placeholder=\"{{'ADD_A_NEW_GROUP' | translate}}\">\n                        </div>\n                        <div class=\"col-sm-3 col-xs-3 col-md-3 col-lg-3\">\n                            <button class=\"btn btn-primary\" ng-click=\"editControlModCtrl.addNewGroupToGroupedSelect()\">\n                                {{'ADD' | translate}}\n                            </button>\n                        </div>\n                    </div>\n                </div>\n            </div>\n            <div class=\"row\">\n                <div class=\"col-lg-3 col-md-3\">\n                    <label class=\" control-label greyText editPropertiesLabel\">{{'EDIT_GROUPS_OPTIONS' | translate}}\n                        :</label>\n                </div>\n            </div>\n            <div class=\"row\">\n                <div class=\"form-group\">\n                    <div class=\"col-lg-12 col-md-12 col-sm-12 col-xs-12\">\n                        <div class=\"container\">\n                            <div ng-if=\"editControlModCtrl.groupedSelectRowCollection.rows.length === 0\">\n                                <h5 class=\"text-center greyText\"><em>- {{'NO_OPTION_ADD_NEW' | translate}} -</em></h5>\n                            </div>\n                            <table ng-if=\"editControlModCtrl.groupedSelectRowCollection.rows.length > 0\"\n                                   class=\"table table-striped\">\n                                <thead>\n                                <tr>\n                                    <th st-ratio=\"20\">{{'ORDER' | translate}}</th>\n                                    <th st-ratio=\"25\">{{'GROUP' | translate}}</th>\n                                    <th st-ratio=\"30\">{{'OPTION' | translate}}</th>\n                                    <th st-ratio=\"25\"></th>\n                                </tr>\n                                <tr>\n                                    <th st-ratio=\"20\"></th>\n                                    <th st-ratio=\"25\"></th>\n                                    <th st-ratio=\"30\">\n                                        <input ng-model=\"editControlModCtrl.groupedSelectFilter\"\n                                               placeholder=\"{{'SEARCH_4_OPTION' | translate}}\"\n                                               class=\"input-sm form-control\" type=\"search\"/>\n                                    </th>\n                                    <th st-ratio=\"25\"></th>\n                                </tr>\n                                </thead>\n                                <tbody>\n                                <tr ng-repeat=\"groupedSelectRow in editControlModCtrl.groupedSelectRowCollection.rows | filter:editControlModCtrl.groupedSelectFilter as groupedSelectRow\">\n                                    <td st-ratio=\"20\">{{$index}}</td>\n                                    <td st-ratio=\"25\">\n                                        <div ng-if=\"editControlModCtrl.groupSelectGroupClick.showList === true\">\n                                            <div ng-if=\"editControlModCtrl.GroupedSelectGroups.list.length === 0\">\n                                                <p class=\"text-left noGroupText\">- {{'NO_GROUP_ADD_NEW' | translate}}\n                                                    -</p>\n                                            </div>\n                                            <div ng-if=\"editControlModCtrl.GroupedSelectGroups.list.length > 0\">\n                                                <ol class=\"nya-bs-select col-sm-12 col-xs-12 col-md-12 col-lg12 editGroupedSelectnyaSelect\"\n                                                    ng-model=\"groupedSelectRow.group\"\n                                                    id=\"modelGroupedOptionGroupedChoose\"\n                                                    disabled=\"editControlModCtrl.GroupedSelectGroups.list.length === 0\">\n                                                    <li class=\"nya-bs-option\"\n                                                        nya-bs-option=\"GroupedSelectGroup in editControlModCtrl.GroupedSelectGroups.list\"\n                                                        value=\"GroupedSelectGroup\">\n                                                        <a>{{GroupedSelectGroup}}</a>\n                                                    </li>\n                                                </ol>\n                                            </div>\n                                        </div>\n                                        <div ng-if=\"editControlModCtrl.groupSelectGroupClick.showList === false\">\n                                            {{groupedSelectRow.group}}\n                                        </div>\n                                    </td>\n                                    <td st-ratio=\"30\">{{groupedSelectRow.option}}</td>\n                                    <td st-ratio=\"25\">\n                                        <div class=\"pull-right\">\n                                            <button class=\"btn btn-primary\"\n                                                    ng-click=\"editControlModCtrl.upThisGroupedSelectRow($index)\"><i\n                                                    class=\"fa fa-arrow-up\"></i></button>\n                                            <button class=\"btn btn-primary\"\n                                                    ng-click=\"editControlModCtrl.downThisGroupedSelectRow($index)\"><i\n                                                    class=\"fa fa-arrow-down\"></i></button>\n                                            <button class=\"btn btn-warning\"\n                                                    ng-click=\"editControlModCtrl.showGroupListToChoose()\"><i\n                                                    class=\"fa fa-pencil-square-o\"></i></button>\n                                            <button class=\"btn btn-danger\"\n                                                    ng-click=\"editControlModCtrl.removeGroupedSelectRow($index)\"><i\n                                                    class=\"fa fa-trash-o\"></i></button>\n                                        </div>\n                                    </td>\n                                </tr>\n                                </tbody>\n                            </table>\n                        </div>\n                    </div>\n                </div>\n            </div>\n            <hr/>\n            <div class=\"marginTopFivepixels\"></div>\n            <div class=\"row\">\n                <div class=\"form-group\">\n                    <label for=\"inputTextDescriptionUpdate\" class=\"col-lg-3 control-label greyText editPropertiesLabel\">{{'DESCRIPTION'\n                        | translate}} :</label>\n                    <div class=\"col-lg-9\">\n                        <input type=\"text\" class=\"form-control\"\n                               ng-model=\"editControlModCtrl.nyaSelect.temporyConfig.formlyDesciption\"\n                               id=\"inputTextDescriptionUpdate\" placeholder=\"{{'ADDEDIT_DESCRIPTION' | translate}}\">\n                    </div>\n                </div>\n            </div>\n        </div>\n    </div>\n</div>\n</div>\n</div>\n\n<div class=\"modal-footer\">\n    <button class=\"btn btn-primary\" ng-class=\"{'disabled': editControlModCtrl.nyaSelect.selectedControl === 'none'}\"\n            ng-click=\"editControlModCtrl.ok()\">{{'OK' | translate}}\n    </button>\n    <button class=\"btn btn-warning\" ng-click=\"editControlModCtrl.cancel()\">{{'CANCEL' | translate}}</button>\n</div>\n\n";
        global.define = __define;
        return module.exports;
});
			...
			edaStepWayEasyFormGenController = (function () {
				...
				_createClass(edaStepWayEasyFormGenController, [{
					...
					value: function showModalAddCtrlToColumn(size, indexLine, numcolumn) {
                        ...
                        var modalInstance = this.$uibModal.open(editControlModal);
	...
	function easyFormSteWayConfig($translateProvider) {
		...
		function controlsList() {
            var controls = [{name: 'empty', enabled: true}, {name: 'Header', enabled: true}, {
                name: 'Subtitle',
                enabled: true
            }, {name: 'TextInput', enabled: true}, {name: 'Password', enabled: true}, {
                name: 'Number',
                enabled: true
            }, {name: 'Email', enabled: true}, {name: 'Date', enabled: true}, {
                name: 'Texarea',
                enabled: true
            }, {name: 'RichTextEditor', enabled: true}, {name: 'Radio', enabled: true}, {
                name: 'Checkbox',
                enabled: true
            }, {name: 'BasicSelect', enabled: true}, {name: 'GroupedSelect', enabled: true}];
			return controls;
		}
